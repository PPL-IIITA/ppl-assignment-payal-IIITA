...
public class initialize extends q5 {
    /* 1st input:girl.txt 
          2nd input:boy.txt
       ...
       // System.out.println("aaa");
        ...
        for(int j=0;j<gs;j++){
         ...
         //   System.out.println("1");
            ...
            // pair making of jth boy
            int gindex=r.pair_making_by_boy(gs, bs,j); 
            ...
            if(gindex!=-1){
             ...
             //   System.out.println(" "+gindex);
                ...
                b[j].gift_basket(g, gs, l, ls, e, es);
                //calculate_happiness(gindex);
            }
