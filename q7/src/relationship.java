...
public class relationship extends q7 {
     ...
     */
     ...
     int pair_making_by_girl(int gs,int n,int gindex,int st){ //boy b is according to girls choice
        //int j;
       // for(j=0;j<gs;j++){
    ...
    /**
     * 
     * @param k   value of k for k happiest couple
     * @param happy1  happiness array
     * @param compat1  compatibility array
     * @param gs   total no of girls
     */
    ...
    /**
     * 
     * @param t  value of t for minimum t happiness value
     * @param gs total no of girls
     * @param bs total no of boys
     * @throws IOException 
     */
